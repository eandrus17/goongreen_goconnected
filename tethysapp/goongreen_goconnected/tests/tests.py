...
# from ..app import GoongreenGoconnected
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.goongreen_goconnected"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.goongreen_goconnected.tests.tests"

        To run tests in the GoongreenGoconnectedTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.goongreen_goconnected.tests.tests.GoongreenGoconnectedTestCase"

        To run only the test_if_tethys_platform_is_great function in the GoongreenGoconnectedTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.goongreen_goconnected.tests.tests.GoongreenGoconnectedTestCase.test_if_tethys_platform_is_great"
...
class GoongreenGoconnectedTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(GoongreenGoconnected)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(GoongreenGoconnected)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/goongreen-goconnected/')  # The final '/' is essential for all pages/controllers
